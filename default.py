...
def get_relicweapon():
    ...
    hfile.copy_folder('./ZodiacWeapons', '../Profiles/ZodiacWeapons')
...
def get_sodimm():
    ...
    hfile.copy_folder('RebornBuddy/Profiles/Sodimm', '../Profiles/Sodimm')
    hfile.copy_folder('RebornBuddy/Downloads/Latest/Sparrow', '../Plugins/Sparrow')
...
def get_y2krazy():
    ...
    hfile.copy_folder('./Rebornbuddy-Profiles', '../Profiles/y2krazy')
...
def get_rbtrust():
    ...
    for file in os.listdir('RBtrust/Quest Behaviors'):
        hfile.copy_file('RBtrust/Quest Behaviors/%s' % (file), '../Quest Behaviors/%s' % (file))
    hfile.copy_folder('RBtrust/Plugins/Trust', '../Plugins/Trust')
    hfile.add_folder('../Profiles', 'Trust')
